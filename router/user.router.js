...
router.post('/register', async (req, res) => {
    ...
    if (req.body.password == req.body.confirmpassword) {
        try {
            ...
            res.status(400).json({ message:"farhan"+ err.message });
        }
    }
    else {
...
router.post('/refer', async (req, res) => {
    if (req.body.password == req.body.confirmpassword) {
        ...
        try {
            ...
            // console.log(referringUser.referredUsers);

            //refer jis ne kiya hai uss k udr rfer code jis ne dale hai uss k id 
